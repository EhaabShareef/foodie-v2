                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-xs font-medium">
                            ...
                            <a href="delete.php?id=<?php echo $admin['id']; ?>" class="text-red-600 hover:text-red-900 mr-2" onclick="return confirm('Are you sure you want to delete this admin?');">Delete</a>
